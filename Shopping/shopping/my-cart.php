...
<td class="cart-product-sub-total"><span class="cart-sub-total-price"><?php echo $row['shippingCharge']; ?>.00 Bath</span></td>
...
<?php }else{ $sc = 90; }?>
					...
					<?php $vat = $_SESSION['tp']*7/100+$_SESSION['tp']+$sc; ?>
							Shipping Charge<span class="inner-left-md"><?php echo $_SESSION['tp']="$sc". ".00"; ?></span><br>

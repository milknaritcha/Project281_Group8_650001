					...
					<div class="products">
						...
						<div class="product-info text-left m-t-20">
							...
							<div class="product-price">	
							    ...
							    <span class="price-before-discount"><?php echo htmlentities($rws['productPriceBeforeDiscount']);?> Bath</span>					
								...
								<div class="row">
									...
									<div class="col-sm-6">
										<div class="favorite-button m-t-10">
											<a class="btn btn-primary" data-toggle="tooltip" data-placement="right" title="Favorite" href="product-details.php?pid=<?php echo htmlentities($row['id'])?>&&action=wishlist">
...
<?php if($row['productAvailability']=="In Stock"){?>
    ...
    <div class="col-sm-7">
										<a class="btn btn-danger"><i class="fa fa-shopping-cart inner-right-vs"></i>Out of Stock</a>
									</div>
      <?php } ?>
				...
				<div class="product-tabs inner-bottom-xs  wow fadeInUp">
					<div class="row">
                        ...
                        <?php $id=mysqli_query($con,"select * from attributes where pro_id='$pid'");
while($ro=mysqli_fetch_array($id))
{

?>
									<div class="product-tab">
										<p class="text"><?php echo $ro['attr_name']; ?> : <?php echo $ro['attr_value']; ?></p>
									</div>
                           <br>	
 <?php } ?>
								</div>

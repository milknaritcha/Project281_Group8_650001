...
if(isset($_GET['del']))
		  {
         $id=mysqli_query($con,"select * from attributes where pro_id='".$_GET['id']."'");
         while($ro=mysqli_fetch_array($id))
         {
                mysqli_query($con,"delete from attributes where attr_id = '".$ro['attr_id']."'");
...
?>									
										<tr>
											...
											<td><a href="insert-attribute.php?id=<?php echo $row['id']; ?>"><?php echo htmlentities($row['productName']);?></a></td>

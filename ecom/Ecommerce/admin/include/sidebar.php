...
<ul class="widget widget-menu unstyled">
						...
						<ul class="widget widget-menu unstyled">
                                ...
                                <li><a href="manage-attributes.php"><i class="menu-icon icon-table"></i>Manage Attributes </a></li>
                                <li><a href="Order.php"><i class="menu-icon icon-table"></i>Order </a></li>
                        
                            </ul><!--/.widget-nav-->

						<ul class="widget widget-menu unstyled">
							<li hidden="hidden"><a href="user-logs.php"><i class="menu-icon icon-tasks"></i>User Login Log </a></li>

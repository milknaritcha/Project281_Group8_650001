...
<html lang="en">
	<head>
	    ...
	    <title>Shopping Milk Home Page</title>
		...
		<div class="row">
			...
			<div class="hidden-md col-sm-4 col-lg-4">
				<div class="info-box">
					...
					<h6 class="text">free ship-on oder over 490.00 Bath</h6>	
				</div>
			</div><!-- .col -->
			<!-- .col -->
		</div><!-- /.row -->
	...
	<div class="product">		
		...
		<div class="product-info text-left">
			...
			<div class="product-price">	
				<span class="price">
					<?php echo htmlentities($row['productPrice']);?> Bath			</span>
     ...
     <?php  }else{ ?>
      <div class="action"><a class="lnk btn btn-danger">Out of Stock</a></div>
      <?php } ?>

...
if(!empty($_SESSION['cart'])){
			...
			<div class="items-cart-inner">
				<div class="total-price-basket">
					...
					<span class="total-price">
						...
						<span class="value"><?php echo $_SESSION['tp']; ?>  <span class="sign">Bath </span></span>
					</span>
				</div>
				<div class="basket">
    ...
    $sql = "SELECT * FROM products WHERE id IN(";
			...
			while($row = mysqli_fetch_array($query)){
				...
				$totalprice += $subtotal * 7 /100 + $subtotal;
	...
	?>
				...
				<div class="cart-item product-summary">
					<div class="row">
						...
						<div class="col-xs-7">
							...
							<div class="price"><?php echo ($row['productPrice']); ?>*<?php echo $_SESSION['cart'][$row['id']]['quantity']; ?> Bath</div>
						</div>
			...
			<div class="clearfix cart-total">
				<div class="pull-right">
						...
						<span class="text">Total :</span><span class='price'><?php echo $_SESSION['tp']="$totalprice"; ?> Bath</span>
			...
			<div class="items-cart-inner">
				<div class="total-price-basket">
					...
					<span class="total-price">
						...
						<span class="value">00.00 Bath</span>
					</span>
				</div>
				<div class="basket">
					<i class="glyphicon glyphicon-shopping-cart"></i>

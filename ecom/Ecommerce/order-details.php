		...
		<table class="table table-bordered">
			<thead>
				<tr>
					...
					<th class="cart-total item">Vat</th>
...
?>
				<tr>
					...
					<td class="cart-product-grand-total"><?php echo $qty*$price*7/100;?></td>
               ...
               <?php $p += $row['pprice']*$row['qty']+(($row['pprice']*$row['qty'])*7/100); ?>
				</tr>
<?php $cnt=$cnt+1;} } else { ?>
		...
		<thead>
			<tr>
				<th>
                  ...
                  Price<span class="inner-left-md"><?php echo $p; ?></span>
					</div>
				</th>
			</tr>
		</thead><!-- /thead -->

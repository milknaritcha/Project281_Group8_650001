...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO categories (cat_id, cat_name) VALUES (%s, %s)",
...
<body>
	<div class="top">
      ...
      <a href="categories.php" class="active">หมวดหมู่สินค้า</a>
      ...
      <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
        <table align="center">
          <tr valign="baseline" hidden="hidden">
            ...
            <td><input type="text" name="cat_id" value="" size="32" /></td>
          </tr>
          <tr valign="baseline">
            <td nowrap="nowrap" align="right">ชื่อหมวดหมู่:</td>
            <td><input type="text" name="cat_name" value="" size="32" /></td>
          </tr>
          <tr valign="baseline">
            <td nowrap="nowrap" align="right">&nbsp;</td>
            <td><input class="button button1" type="submit" value="เพิ่มหมวดหมู่" /><input class="button button2" type="button" onclick="window.history.back()" value="ยกเลิก" /></td>
          </tr>
        </table>

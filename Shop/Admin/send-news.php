  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      <ul class="nav navbar-nav">
        ...
        <li class="active"><a href="send-news.php">แจ้งรายการโปรโมชั่น</a></li>
...
<br>  
  ...
  <h2>แจ้งเตือนโปรโมชั่น</h2>
</div>

<form class="w3-container" method="post" action="send.php">
  <p>
  <label style="float:left">หัวข้อข่าวสาร</label>
  <input class="w3-input" name="subject" type="text" placeholder="หัวข้อข่าวสาร" required></p>
  <p>
  <label style="float:left">เนื้อหา</label>
  <textarea class="w3-input" name="body" type="text" rows="5" placeholder="เนื้อหาข่าวสาร" required></textarea></p>
  <button class="w3-button w3-blue">ส่ง</button>
</form>
</div>
    </div>
    <div class="col-sm-2 sidenav" style="background-color:#FFF">

...
<br>  
  <div class="row content">
    ...
    <div class="col-sm-8 text-center">
      ...
      <form method="POST" action="<?php echo $editFormAction; ?>" name="insert" class="w3-container">
          <p>
          <label style="float:left">ชื่อหมวดหมู่</label>
          <input name="cat_name" class="w3-input" type="text" placeholder="กรุณากรอกชื่อหมวดหมู่" required></p>

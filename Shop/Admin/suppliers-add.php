...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "insert")) {
  $insertSQL = sprintf("INSERT INTO suppliers (sup_name, address, phone, contact_name, website) VALUES (%s, %s, %s, %s, %s)",
  ...
  <div class="row content">
    ...
    <div class="col-sm-8 text-center">
   	  <div class="w3-container w3-green">
          <h2>เพิ่มผู้จัดส่งสินค้า</h2>
        </div>
      <form action="<?php echo $editFormAction; ?>" method="POST" name="insert" class="w3-container">
          <p>
          <label style="float:left">ชื่อผู้จัดส่งสินค้า</label>
          <input name="sup_name" class="w3-input" type="text" placeholder="กรุณากรอกชือผู้จัดส่งสินค้า" required></p>
          <p>
          <label style="float:left">ที่อยู่</label>
          <textarea name="address" class="w3-input" type="text" placeholder="กรุณากรอกที่อยู่" rows="5" required></textarea></p>
          <p>
          <label style="float:left">เบอร์โทรศัพท์</label>
          <input name="phone" class="w3-input" type="tel" placeholder="กรุณากรอกเบอร์โทรศัพท์" required></p>
          <p>
          <label style="float:left">บุคคลในการติดต่อ</label>
          <input name="contact" class="w3-input" type="text" placeholder="กรุณากรอกชื่อบุคคลในการติดต่อ" required></p>
          <label style="float:left">เว็บไซต์</label>
          <input name="website" class="w3-input" type="text" placeholder="กรุณากรอกเว็บไซต์" ></p>

...
$query_Recordset1 = sprintf("SELECT * FROM products WHERE pro_id = %s", GetSQLValueString($colname_Recordset1, "int"));
$Recordset1 = mysql_query($query_Recordset1, $mydbshop) or die(mysql_error());
				...
				<div class="row">
					<div class="span9">					
						...
						<table class="table table-striped">
						  ...
						  <td></td> 
                                    <td></td>
                                    <td><?php echo $row_Recordset1['pro_name']; ?></td>
                                    <td></td>

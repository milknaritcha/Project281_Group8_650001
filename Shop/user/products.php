...
$query_products = "SELECT products.pro_id, products.cat_id, products.sup_id, products.pro_name, products.price, products.quantity, products.details, products.images, categories.cat_name FROM products, categories WHERE products.cat_id=categories.cat_id";
						...
						<ul class="thumbnails listing-products">
						    ...
						    <li class="span3">
							    <div class="product-box">
                                  ...
                                  <br>
                                  <br>
                                  <a href="cart.php?id=<?php echo $row_products['pro_id']; ?>">
						...
						<div class="pagination pagination-small pagination-centered">
                        	<ul>
                              <?php if ($pageNum_products > 0) { // Show if not first page ?>
                                <li><a href="<?php printf("%s?pageNum_products=%d%s", $currentPage, max(0, $pageNum_products - 1), $queryString_products); ?>" >Prev</a></li>
                                <?php } // Show if not first page ?>
<?php 
							  for($i = 0;$i<=$totalPages_products;$i++){
								  echo '<li><a href="?pageNum_products=',$i,'" class="w3-button w3-hover-green">',($i+1) ,'</a></li>';
							  }?>
<?php if ($pageNum_products < $totalPages_products) { // Show if not last page ?>
  <li><a href="<?php printf("%s?pageNum_products=%d%s", $currentPage, min($totalPages_products, $pageNum_products + 1), $queryString_products); ?>">Next</a></li>
